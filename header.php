...
<head>
    ...
    <link rel="mask-icon" href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon/safari-pinned-tab.svg" color="#d65228">
            ...
            <div class="fixed-top bg-dark">
                ...
                <nav id="nav-main" class="navbar navbar-expand-md navbar-dark">
                    ...
                    <div class="container header-container">
                        ...
                        <!-- Navbar Brand -->
                        <a class="navbar-brand" href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/img/logo/logo.svg" alt="Council for University Programs" width="200px" height="auto" class="logo md p-2 lazyloaded"></a>
